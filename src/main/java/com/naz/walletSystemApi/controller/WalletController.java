...
public class WalletController {
    ...
    public ResponseEntity<ResponseDto> create(@Valid @RequestBody CreateWalletRequestDto request) {
        String res = walletService.createWallet(request.userId);
    ...
    @PostMapping("/{id}/fund")
    public ResponseEntity<ResponseDto> fund(@PathVariable String id,
                                       @Valid @RequestBody AmountRequestDto request) {
        String res = walletService.fundWallet(id, request.amount);
        return ResponseEntity
    ...
    public ResponseEntity<ResponseDto> debit(@PathVariable String id,
                                        @Valid @RequestBody AmountRequestDto request) {
        String res = walletService.debitWallet(id, request.amount);
        return ResponseEntity
                .status(HttpStatus.OK)
                .body(new ResponseDto(HttpStatus.OK, res));
    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity<WalletResponseDto> get(@PathVariable String id) {
